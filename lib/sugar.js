...
// Object.max =function(object) {
  // //create a variable for max value
  // //loop through and look at values
  // //if max value undefined or
  // //if value of obj is bigger than max value update max value
  // //return max value
  // //...= srpread syntax goes through each number and then returns the smallest number.
...
function get(object, key) {
  ...
  //search the new object for the key that is required
  //if you find that key return vlaue
